...
/**
 * This is the test fixture for these tests,
...
TEST_F(FileTests, BasicFileMethod) {
...
TEST_F(FileTests, RepurposeFileObject) {
    ...
    // Implicitly cast testFilePath2 to a SystemAbstractions::File,
...
TEST_F(FileTests, ReadBackWithSizeAndOffsets) {
    ...
    ASSERT_EQ(5, file.Read(buffer, 5, 3));
    ASSERT_EQ((std::vector<uint8_t>{0, 0, 0, 'W', 'o', 'r', 'l', 'd', 0}), buffer);
}
