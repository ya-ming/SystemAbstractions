...
namespace SystemAbstractions {
    ...
    public:
        /**
         * This is the type of callback function to be called whenever a
        ...
        typedef std::function<
            void(uint32_t address, uint16_t port, const std::vector<uint8_t>& body)
    ...
    public:
         ...
         *     This is the callback function to be called whenever a new client connects to the network endpoint.
         *
         * @param[in] packetReceivedDelegate
         *     This is the callback function to be called whenever a new datagram-oriented message is received
         *     by the network endpoint.
         *
         * @param[in] mode
